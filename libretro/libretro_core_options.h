...
struct retro_core_option_definition option_defs_us[] = {
   ...
   {
      "vitaquakeii_aspect",
      "Display aspect (restart)",
      "Modify aspect ratio. Requires a restart.",
      {
         { "4:3",              NULL},
         { "Widescreen",            NULL},
         { NULL, NULL },
   ...
   {
      "vitaquakeii_resolution_43",
      "Internal 4:3 resolution (restart)",
      "Configure the 4:3 resolution. Requires a restart.",
      {
         { "320x240",   NULL },
         { "640x480",   NULL },
         { "960x720",   NULL },
   ...
   {
      "vitaquakeii_resolution_169",
      "Internal widescreen resolution (restart)",
      "Configure the widescreen resolution. Requires a restart.",
      {
         { "480x272",   NULL },
         { "640x368",   NULL },
         { "720x408",   NULL },
...
struct retro_core_option_definition option_defs_it[] = {
   ...
   },
   {
      "vitaquakeii_aspect",
      "Proporzioni (riavvio)",
      "Modifica le proporzioni. Richiede un riavvio.",
      {
         { "4:3",              NULL},
         { "Widescreen",            NULL},
         { NULL, NULL },
   ...
   {
      "vitaquakeii_resolution_43",
      "Risoluzione interna 4:3 (riavvio)",
      "Configura la risoluzione 4:3. Richiede un riavvio.",
      {
         { "320x240",   NULL },
         { "640x480",   NULL },
         { "960x720",   NULL },
   ...
   {
      "vitaquakeii_resolution_169",
      "Risoluzione interna widescreen (riavvio)",
      "Configura la risoluzione schermo largo. Richiede un riavvio.",
      {
         { "480x272",   NULL },
         { "640x368",   NULL },
         { "720x408",   NULL },
